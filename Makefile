##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.7.0-B52] date: [Sun Mar 15 20:13:22 CST 2026] 
##########################################################################################################################
...
application/custom_controller/custom_controller.c \
application/robot.c \
Src/sysmem.c \
Src/syscalls.c
# ASM sources
...
-Iapplication/gimbal \
-Iapplication/cmd \
-Iapplication/custom_controller \
-Iapplication \
-Ibsp/dwt \
-Ibsp/can \
-Ibsp/usart \
