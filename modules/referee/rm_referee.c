	...
	if (vt_buff[SOF] == REFEREE_SOF)
	{
		...
		//if(1)
		{
			...
			// {
				...
				switch (referee_vt_info.CmdID)
				{
				case ID_self_ctrl: // 0x0302
					memcpy(&referee_vt_info.CustomRobot, (vt_buff + DATA_Offset), LEN_self_ctrl_data_t);
					break;
